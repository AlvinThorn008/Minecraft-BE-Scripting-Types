 ...
 */
export declare type clientEvents = "minecraft:client_entered_world" | "minecraft:hit_result_changed" | "minecraft:hit_result_continuous" | "minecraft:pick_hit_result_changed" | "minecraft:pick_hit_result_continuous";
 ...
 */
export declare type triggerableClientEvents = "minecraft:display_chat_event" | "minecraft:load_ui" | "minecraft:script_logger_config" | "minecraft:send_ui_event" | "minecraft:spawn_particle_attached_entity" | "minecraft:spawn_particle_in_world" | "minecraft:unload_ui";
 ...
 */
export declare type triggerableServerEvents = "minecraft:display_chat_event" | "minecraft:entity_definition_event" | "minecraft:execute_command" | "minecraft:play_sound" | "minecraft:script_logger_config" | "minecraft:spawn_particle_attached_entity" | "minecraft:spawn_particle_in_world";
/**
 * EventMap
 ...
 */
export declare type BroadcastEventMap = TriggerableServerEventMap & TriggerableClientEventMap;
/**
 * ListenEventMap
 * Contains all mappings for all events that can be listened to.
 * This also serves as a mapping for all defined events.
 */
export declare type ListenEventMap = ClientEventMap & ServerEventMap & BroadcastEventMap;
/**
 * CustomEventMap
